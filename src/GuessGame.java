public class GuessGame {
    ...
    public void startGame() {
        ...
        // Объявляем три переменных для хранения правильности или неправильности (true или false) ответов игроков
        ...
        System.out.println("Я загадываю число от 0 да 9...");
        ...
        while (true) {
            ...
            // Если игрок угадал, то присваиваем соответсвующей переменной значение true (помните, что по умолчанию она хранит значение false)
